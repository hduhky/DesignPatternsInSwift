...
class BaseQueryBuilder<Model: BuilderDomainModel> {
...
class RealmQueryBuilder<Model: BuilderDomainModel>: BaseQueryBuilder<Model> {
...
class CoreDataQueryBuilder<Model: BuilderDomainModel>: BaseQueryBuilder<Model> {
...
class RealmProvider {
    ...
    func fetch<Model: BuilderDomainModel>(_ operations: [RealmQueryBuilder<Model>.Query]) -> [Model] {
...
class CoreDataProvider {
    ...
    func fetch<Model: BuilderDomainModel>(_ operations: [CoreDataQueryBuilder<Model>.Query]) -> [Model] {
...
protocol BuilderDomainModel {
    /// The protocol groups domain models to the common interface
}

private struct BuilderUser: BuilderDomainModel {
    let id: Int
    let age: Int
    let email: String
}
...
class BuilderRealWorld: XCTestCase {
    ...
    func testBuilderRealWorld() {
        ...
        clientCode(builder: RealmQueryBuilder<BuilderUser>())

        print()

        print("Client: Start fetching data from CoreData")
        clientCode(builder: CoreDataQueryBuilder<BuilderUser>())
    }

    fileprivate func clientCode(builder: BaseQueryBuilder<BuilderUser>) {
